defmodule ElixirgroupWeb.ProductControllerTest do
  use ElixirgroupWeb.ConnCase

  alias Elixirgroup.Products

  @create_attrs %{description: "some description", price: 120.5}
  ...
  describe "index" do
    test "lists all first_product", %{conn: conn} do
      conn = get(conn, Routes.product_path(conn, :index))
      assert html_response(conn, 200) =~ "Listing First product"
    end
  end
