defmodule ElixirgroupWeb.UserAuthTest do
  use ElixirgroupWeb.ConnCase, async: true

  alias Elixirgroup.Accounts
  alias ElixirgroupWeb.UserAuth
  import Elixirgroup.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ElixirgroupWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ElixirgroupWeb.Endpoint.subscribe(live_socket_id)
